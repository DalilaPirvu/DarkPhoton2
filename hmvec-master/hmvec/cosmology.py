...
class Cosmology(object):
    ...
    def _init_cosmology(self,params,halofit):
        ...
        try:        
            ...
            pass        
        self.pars = camb.set_params(lmax=10000, ns=params['ns'],As=params['As'],H0=H0,
    ...
    def CMB_power_spectra(self):
        return self.results.get_cmb_power_spectra(self.pars, lmax=10000, raw_cl=True, CMB_unit='muK')
    ...
    def _get_matter_power_hunits(self,zs,ks,nonlinear=False):
        PK = camb.get_matter_power_interpolator(self.pars, nonlinear=nonlinear, 
                                                hubble_units=True,
                                                k_hunit=True, kmax=ks.max(),
                                                zmax=zs.max()+1.)
        return (self.as8**2.) * PK.P(zs, ks, grid=True)
